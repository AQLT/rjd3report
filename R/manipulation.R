...
get_jmod.JD3_X13_OUTPUT <- function(x, ...) {
  rjd3x13::jx13(ggdemetra3::raw(x), x$result_spec)
}
get_jmod.JD3_TRAMOSEATS_OUTPUT <- function(x, ...) {
  rjd3tramoseats::jtramoseats(ggdemetra3::raw(x), x$result_spec)
}
